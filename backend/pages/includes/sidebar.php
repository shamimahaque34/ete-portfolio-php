...
<!-- {{--                <img src="{{ asset('/') }}admin/assets/images/brand/logo-3.png" class="header-brand-img light-logo1" alt="logo">--}} -->
                <h3 class="header-brand-img desktop-logo text-white">Shamima</h3>
<!-- {{--                <h3 class="header-brand-img toggle-logo text-white">OTMS</h3>--}}
{{--                <h3 class="header-brand-img light-logo text-black">OTMS</h3>--}} -->
                <h3 class="header-brand-img light-logo1 text-black">Shamima</h3>
            </a><!-- LOGO -->
        </div>
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Portfolio Management</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
