                    ...
                    <div class="card-body">
                        ...
                        <form action="action.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea name="address" class="form-control"><?php echo $designation; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="submit" name="updateContactBtn" class="btn btn-success btn-block" value="Edit"/>
                                </div>
                            </div>
                        </form>
                    </div>
